    ...
    return (
      <header className="absolute top-0 left-0 right-0 z-50">
        <div className="mx-auto max-w-[980px] px-4 pt-5 md:pt-7">
          <nav
            className="relative mx-auto flex h-12 md:h-14 items-center justify-between rounded-full border border-[#e8c25a]/60 px-4 md:px-6 text-[#3a2a08] shadow-[0_10px_40px_-12px_rgba(212,160,40,0.25)] backdrop-blur-2xl"
            style={{ background: "linear-gradient(135deg, rgba(255,225,130,0.95), rgba(232,178,60,0.95))" }}
          >
